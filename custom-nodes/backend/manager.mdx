...
{/*
description: "Understand how to publish a custom node to the Hanzo Manager database."
*/}
...
[Hanzo Manager](https://github.com/ltdrdata/ComfyUI-Manager) to install them. **Hanzo Manager** takes care of installing, 
...
See [Hanzo Manager Install](https://github.com/ltdrdata/ComfyUI-Manager?tab=readme-ov-file#installation) for details or special cases.

*/}

### Using Hanzo Manager

To make your custom node available through **Hanzo Manager** you need to save it as a git repository (generally at `github.com`)
and then submit a Pull Request on the **Hanzo Manager** git, in which you have edited `custom-node-list.json` to add your node.
[More details](https://github.com/ltdrdata/ComfyUI-Manager?tab=readme-ov-file#how-to-register-your-custom-node-into-hanzo-studio-manager).

When a user installs the node, **Hanzo Manager** will:
...
As indicated above, there are a number of files and scripts that **Hanzo Manager** will use to manage the lifecycle of 
...
See the [Hanzo Manager guide](https://github.com/ltdrdata/ComfyUI-Manager?tab=readme-ov-file#custom-node-support-guide) for official details.
