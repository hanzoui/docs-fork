...
The Bottom Panel Tabs API allows extensions to add custom tabs to the bottom panel of the Hanzo Studio interface. This is useful for adding features like logs, debugging tools, or custom panels.
