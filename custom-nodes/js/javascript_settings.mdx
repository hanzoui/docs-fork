...
You can provide a settings object to Hanzo Studio that will show up when the user
opens the Hanzo Studio settings panel.
...
Props described in the PrimeVue documentation can be defined for Hanzo Studio
