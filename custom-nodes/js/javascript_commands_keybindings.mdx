...
- Keybindings defined in the Hanzo Studio core cannot be overwritten by extensions. Check the core keybindings in these source files:
  - [Core Commands](https://github.com/hanzoui/frontend/blob/e76e9ec61a068fd2d89797762f08ee551e6d84a0/src/composables/useCoreCommands.ts)
  - [Core Menu Commands](https://github.com/hanzoui/frontend/blob/e76e9ec61a068fd2d89797762f08ee551e6d84a0/src/constants/coreMenuCommands.ts) 
  - [Core Keybindings](https://github.com/hanzoui/frontend/blob/e76e9ec61a068fd2d89797762f08ee551e6d84a0/src/constants/coreKeybindings.ts)
  - [Reserved Key Combos](https://github.com/hanzoui/frontend/blob/e76e9ec61a068fd2d89797762f08ee551e6d84a0/src/constants/reservedKeyCombos.ts)
