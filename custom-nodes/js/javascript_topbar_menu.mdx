...
The Topbar Menu API allows extensions to add custom menu items to the Hanzo Studio's top menu bar. This is useful for providing access to advanced features or less frequently used commands.
...
Commands can work with other Hanzo Studio APIs like settings. For more information about the Settings API, see the [Settings API](./javascript_settings) documentation.