...
The About Panel Badges API allows extensions to add custom badges to the Hanzo Studio about page. These badges can display information about your extension and contain links to documentation, source code, or other resources.
...
Badges appear in the About panel of the Settings dialog, which can be accessed via the gear icon in the top-right corner of the Hanzo Studio interface.