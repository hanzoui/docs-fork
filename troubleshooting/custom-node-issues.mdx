...
- Hanzo Studio crashes or won't start
...
Most Hanzo Studio issues are caused by custom nodes (extensions). Let's check if this is the case.

### Step 1: Test with all custom nodes disabled

Run Hanzo Studio with all custom nodes disabled:
...
- Test → Issue persists ✓
- Problem is in: HanzoStudio-AnimateDiff-Evolved, HanzoStudio-FaceRestore, HanzoStudio-Advanced-ControlNet, HanzoStudio-Inspire-Pack

**Round 2:** Move 2 of the remaining 4 to temp
- Test → Issue gone ✓
- Problem is in: HanzoStudio-Advanced-ControlNet, HanzoStudio-Inspire-Pack

**Round 3:** Move 1 of the remaining 2 to temp
- Test → Issue persists ✓
- **Found it!** HanzoStudio-Inspire-Pack is the problematic node
