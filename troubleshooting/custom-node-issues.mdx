...
- Test → Issue persists ✓
- Problem is in: Hanzo Studio-AnimateDiff-Evolved, Hanzo Studio-FaceRestore, Hanzo Studio-Advanced-ControlNet, Hanzo Studio-Inspire-Pack

**Round 2:** Move 2 of the remaining 4 to temp
- Test → Issue gone ✓
- Problem is in: Hanzo Studio-Advanced-ControlNet, Hanzo Studio-Inspire-Pack

**Round 3:** Move 1 of the remaining 2 to temp
- Test → Issue persists ✓
- **Found it!** Hanzo Studio-Inspire-Pack is the problematic node
