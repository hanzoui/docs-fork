...
<Tabs>
<Tab title="Windows">
- **Unsupported device**: Hanzo Desktop Windows only supports NVIDIA GPUs with CUDA. Use [Hanzo Studio Portable](/installation/hanzo_studio_portable_windows) or [manual installation](/installation/manual_install) for other GPUs
...
python -m venv hanzo_studio_env
source hanzo_studio_env/bin/activate  # Linux/Mac
hanzo_studio_env\Scripts\activate     # Windows
```
...
**Solutions:**
1. **Check firewall settings** - Allow Hanzo Studio through firewall
...
```bash
# After updating Hanzo Studio via Git, update frontend dependencies
pip install -r requirements.txt
```

**"Can't Find Custom Node":**
- Disable node validation in Hanzo Studio settings

**"Error Toast About Workflow Failing Validation":**
- Disable workflow validation in settings temporarily
- Report the issue to the Hanzo Studio team

**Login Issues When Not on Localhost:**
- Normal login only works when accessing from localhost
- For LAN/remote access: Generate API key at [platform.hanzo.ai/login](https://platform.hanzo.ai/login)
...
1. **Check if it's a known issue:**
   - Search [GitHub Issues](https://github.com/hanzoai/studio/issues)
   - Check [Hanzo Studio Forum](https://forum.hanzo.ai/)
   - Review [Discord discussions](https://discord.com/invite/hanzoai)
...
2. **Try basic troubleshooting:**
   ...
   - If using hanzo-cli, try updating: `comfy node update all`

### How to Report Bugs Effectively

#### For Hanzo Studio Core Issues
**Where to report:** [GitHub Issues](https://github.com/hanzoai/studio/issues)

#### For Desktop App Issues
**Where to report:** [Desktop GitHub Issues](https://github.com/hanzoui/desktop/issues)

#### For Frontend Issues
**Where to report:** [Frontend GitHub Issues](https://github.com/hanzoui/studio_frontend/issues)
...
<Tabs>
<Tab title="From Hanzo Studio Interface">
**System Information (can be found in the About page in settings):**
- Operating System (Windows 11, macOS 14.1, Ubuntu 22.04, etc.)
- Hanzo Studio version (check About page in settings)
- Python version: `python --version`
- PyTorch version: `python -c "import torch; print(torch.__version__)"`
- GPU model and driver version
- Installation method (Desktop, Portable, Manual, hanzo-cli)
...
- Log files from: `C:\Users\<username>\AppData\Roaming\Hanzo Studio\logs` (Windows)
- Config files from: `C:\Users\<username>\AppData\Roaming\Hanzo Studio` (Windows)
</Step>
...
- **Official Forum:** [forum.hanzo.ai](https://forum.hanzo.ai/)
- **Discord:** [Hanzo Studio Discord Server](https://discord.com/invite/hanzoai)
- **Reddit:** [r/comfyui](https://reddit.com/r/comfyui)
- **YouTube:** [Hanzo Studio Tutorials](https://www.youtube.com/@comfyorg)
