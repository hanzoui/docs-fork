---
title: "ClipTextEncode - Hanzo Studio Built-in Node Documentation"
...
2. **Special Feature: Using Embedding Models**
   ...
   - How to use:
     1. Place the embedding model file (in .pt format) in the `Hanzo Studio/models/embeddings` folder
