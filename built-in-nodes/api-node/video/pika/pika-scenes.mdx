---
title: "Pika 2.2 Scenes - Hanzo Studio Built-in Node Documentation"
description: "A node that creates coherent scene videos from multiple images using Pika AI"
sidebarTitle: "Pika 2.2 Scenes"
icon: "circle"
---

![Hanzo Studio Built-in Pika 2.2 Scenes Node](/images/built-in-nodes/api_nodes/pika/pika-2-2-scenes.jpg)
