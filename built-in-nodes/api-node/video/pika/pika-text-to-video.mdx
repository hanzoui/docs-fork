---
title: "Pika 2.2 Text to Video - Hanzo Studio Native Node Documentation"
description: "A node that converts text descriptions into videos using Pika AI"
sidebarTitle: "Pika 2.2 Text to Video"
icon: "circle"
---

![Hanzo Studio Native Pika 2.2 Text to Video Node](/images/built-in-nodes/api_nodes/pika/pika-2-2-text-to-video.jpg)
