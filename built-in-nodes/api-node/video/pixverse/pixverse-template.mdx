---
title: "PixVerse Template - Hanzo Studio Native Node Documentation"
description: "A helper node that provides preset templates for PixVerse video generation"
sidebarTitle: "PixVerse Template"
icon: "circle"
---

![Hanzo Studio Native PixVerse Template Node](/images/built-in-nodes/api_nodes/pixverse/pixverse-template.jpg)
