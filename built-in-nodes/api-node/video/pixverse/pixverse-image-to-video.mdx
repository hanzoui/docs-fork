---
title: "PixVerse Image to Video - Hanzo Studio Native Node Documentation"
description: "A node that converts static images to dynamic videos using PixVerse AI"
sidebarTitle: "PixVerse Image to Video"
icon: "circle"
---

![Hanzo Studio Native PixVerse Image to Video Node](/images/built-in-nodes/api_nodes/pixverse/pixverse-image-to-video.jpg)
