---
title: "MiniMax Text to Video - Hanzo Studio Native Node Documentation"
description: "A node that converts text descriptions into videos using MiniMax AI"
sidebarTitle: "MiniMax Text to Video"
icon: "circle"
---

![Hanzo Studio Native MiniMax Text to Video Node](/images/built-in-nodes/api_nodes/minimax/minimax-text-to-video.jpg)
