---
title: "MiniMax Image to Video - Hanzo Studio Native Node Documentation"
description: "A node that converts static images to dynamic videos using MiniMax AI"
sidebarTitle: "MiniMax Image to Video"
icon: "circle"
---

![Hanzo Studio Native MiniMax Image to Video Node](/images/built-in-nodes/api_nodes/minimax/minimax-image-to-video.jpg)
