---
title: "Kling Camera Controls - Hanzo Studio Built-in Node Documentation"
description: "A node that provides camera control parameters for Kling video generation"
sidebarTitle: "Kling Camera Controls" 
icon: "circle"
---

![Hanzo Studio Built-in Kling Camera Controls Node](/images/built-in-nodes/api_nodes/kwai_vgi/kling-camera-controls.jpg)
