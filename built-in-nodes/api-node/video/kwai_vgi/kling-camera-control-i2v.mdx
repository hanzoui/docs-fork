---
title: "Kling Image to Video (Camera Control) - Hanzo Studio Built-in Node"
description: "Image to video conversion node with camera control features"
sidebarTitle: "Kling Image to Video (Camera Control)"
icon: "circle"
---

![Hanzo Studio Built-in Kling Image to Video (Camera Control) Node](/images/built-in-nodes/api_nodes/kwai_vgi/kling-camera-control-i2v.jpg)
