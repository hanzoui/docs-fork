---
title: "OpenAI GPT Image 1 - Hanzo Studio Native Node Documentation"
description: "Node for generating images using OpenAI's GPT-4 Vision model"
sidebarTitle: "OpenAI GPT Image 1"
icon: "circle"
---

![Hanzo Studio Native OpenAI GPT Image 1 Node](/images/built-in-nodes/api_nodes/openai/openai-gpt-image-1.jpg)
