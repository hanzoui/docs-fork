---
title: "Ideogram V2 - Hanzo Studio Built-in Node Documentation"
description: "Node for creating high-quality images and text rendering using Ideogram V2 API"
sidebarTitle: "Ideogram V2"
icon: "circle"
---

![Hanzo Studio Built-in Ideogram V2 Node](/images/built-in-nodes/api_nodes/ideogram/ideogram-v2.jpg)
