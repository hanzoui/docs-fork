...
### 1. Community Value
Custom nodes must provide valuable functionality to the Hanzo Studio community
...
#### Reasoning
- First item
Hanzo Studio manager will ship with Hanzo Studio and lets the user install dependencies
- Centralized dependency management improves security and user experience
- Helps prevent potential supply chain attacks
- Eliminates need for multiple Hanzo Studio reloads
