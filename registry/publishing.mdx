...
Go [here](https://registry.hanzo.ai/nodes) and click on the publisher you want to create an API key for. This will be used to publish a custom node via the CLI. 
