---
title: 'Integration of API Key to use Hanzo Studio API nodes'
description: 'This article explains how to use Hanzo Studio API Key to call Hanzo Studio API nodes in headless mode'
sidebarTitle: 'API Key Integration'
---

Starting from [PR #8041](https://github.com/hanzoai/studio/pull/8041), Hanzo Studio supports directly using built-in API nodes through API Keys, without requiring a specific frontend interface (you can even run without a frontend).
...
Using API Key to call Hanzo Studio's built-in API nodes requires:
- API Key for the corresponding account
- Sufficient account credits

To use API Key to call Hanzo Studio's built-in API nodes, you need to first register an account on [Hanzo Studio Platform](https://platform.hanzo.ai/login) and create an API key
...
- API nodes overview: https://docs.hanzo.ai/tutorials/api-nodes/overview
