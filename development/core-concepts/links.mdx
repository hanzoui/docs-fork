---
title: "Links"
description: "Understand connection links in Hanzo Studio"
icon: "share-nodes"
---

<Note>
As Hanzo Studio is still in rapid iteration and development, we are continuously improving it every day. Therefore, some operations mentioned in this article may change or be omitted. Please refer to the actual interface. If you find changes in actual operations, it may be due to our iterative updates. You can also fork [this repo](https://github.com/hanzoui/docs) and help us improve this documentation.
</Note>

## Links connect nodes

In the terminology of Hanzo Studio, the lines or curves between nodes are called **_links_**. They're also known as **_connections_** or wires. Links can be displayed in several ways, such as curves, right angles, straight lines, or completely hidden.
...
![Hanzo Studio Reroute node](/images/interface/link/reroute.jpg)
...
![Hanzo Studio Native Reroute](/images/interface/link/native_reroute.jpg)
