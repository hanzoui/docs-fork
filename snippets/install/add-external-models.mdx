...
- On macOS: `~/Library/Application Support/HanzoStudio/extra_models_config.yaml`
  - Open Finder, press `Cmd+Shift+G` and enter `~/Library/Application Support/HanzoStudio`
- On Linux: `~/.config/HanzoStudio/extra_models_config.yaml`
  - Open your file manager and navigate to the hidden folder `~/.config/HanzoStudio`
