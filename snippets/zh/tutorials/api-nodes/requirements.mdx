...
请更新你的 Hanzo Studio 到最新版本，由于我们后期可能会新增更多的 API 支持, 相应的节点也会进行更新, 所以请保持你的 Hanzo Studio 处于最新版本。
...
需要当前已经在 Hanzo Studio 中登录了 [Comfy账号](/zh-CN/interface/user)，并且账户[积分](/zh-CN/interface/credits)大于 0
