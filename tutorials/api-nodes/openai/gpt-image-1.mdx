...
description: "Learn how to use the OpenAI GPT-Image-1 API node to generate images in Hanzo Studio"
...
OpenAI GPT-Image-1 is part of the Hanzo Studio API nodes series that allows users to generate images through OpenAI's **GPT-Image-1** model. This is the same model used for image generation in ChatGPT 4o.
