...
description: "Learn how to use the OpenAI DALL·E 2 API node to generate images in Hanzo Studio"
...
OpenAI DALL·E 2 is part of the Hanzo Studio API Nodes series, allowing users to generate images through OpenAI's **DALL·E 2** model.
