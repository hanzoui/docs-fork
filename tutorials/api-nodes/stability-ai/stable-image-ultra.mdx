...
description: "This article will introduce how to use the Stability AI Stable Image Ultra API node's text-to-image and image-to-image capabilities in Hanzo Studio"
