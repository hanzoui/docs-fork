---
title: "Hanzo Studio Native HiDream-e1 Workflow Example"
...
**Hanzo Studio now natively supports HiDream E1**. In this guide, we will help you complete the workflow example of using HiDream E1 in Hanzo Studio.
...
## Hanzo Studio Native HiDream-e1 Workflow Example

<Tip>
Please upgrade your Hanzo Studio to the latest version (latest commit) before starting to ensure your Hanzo Studio has the relevant support.
</Tip>
...
![Hanzo Studio Native HiDream-e1 Workflow Input Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/hidream_e1/input.webp)

### 2. Manual Model Installation for HiDream-e1 Related Models

All models mentioned in this guide can be found [here](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/tree/main/split_files). Please download the corresponding files and save them to the appropriate folders.
...
**VAE**
-  [ae.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/blob/main/split_files/vae/ae.safetensors) This is Flux's VAE model. If you have used Flux workflows before, you may have already downloaded this file.

**diffusion models**
- [hidream_e1_full_bf16.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/resolve/main/split_files/diffusion_models/hidream_e1_full_bf16.safetensors)
