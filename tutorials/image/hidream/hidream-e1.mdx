...
All models mentioned in this guide can be found [here](https://huggingface.co/hanzoui/HiDream-I1_HanzoStudio/tree/main/split_files). Please download the corresponding files and save them to the appropriate folders.
...
**VAE**
-  [ae.safetensors](https://huggingface.co/hanzoui/HiDream-I1_HanzoStudio/blob/main/split_files/vae/ae.safetensors) This is Flux's VAE model. If you have used Flux workflows before, you may have already downloaded this file.

**diffusion models**
- [hidream_e1_full_bf16.safetensors](https://huggingface.co/hanzoui/HiDream-I1_HanzoStudio/resolve/main/split_files/diffusion_models/hidream_e1_full_bf16.safetensors)
