---
title: "Hanzo Studio Wan2.1 Fun Control Video Examples"
description: "This guide demonstrates how to use Wan2.1 Fun Control in Hanzo Studio to generate videos with control videos"
...
Hanzo Studio now **natively supports** the Wan2.1 Fun Control model. Before starting this tutorial, please update your Hanzo Studio to ensure you're using a version after [this commit](https://github.com/hanzoai/studio/commit/3661c833bcc41b788a7c9f0e7bc48524f8ee5f82).
...
The following models can be found at [Wan_2.1_HanzoStudio_repackaged](https://huggingface.co/hanzoui/Wan_2.1_HanzoStudio_repackaged) and [Wan2.1-Fun](https://huggingface.co/collections/alibaba-pai/wan21-fun-67e4fb3b76ca01241eb7e334)
...
- [wan2.1_fun_control_1.3B_bf16.safetensors](https://huggingface.co/hanzoui/Wan_2.1_HanzoStudio_repackaged/resolve/main/split_files/diffusion_models/wan2.1_fun_control_1.3B_bf16.safetensors?download=true)
...
Thanks to our powerful Hanzo Studio authors who provide feature-rich nodes. If you want to directly check the related version, see [Workflow Using Custom Nodes](#workflow-using-custom-nodes).
...
![Wan2.1 Fun Control Native Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/wan2.1_fun_control_native.webp)

#### 1.2 Input Images and Videos Download

Please download the following image and video for input:

![Input Reference Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/input/01-portrait_remix.png)

![Input Reference Video](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/input/01-portrait_video.webp)
...
- Use tools like [Hanzo Studio-hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) for richer control options

## Workflow Using Custom Nodes

We'll need to install the following two custom nodes:

- [Hanzo Studio-VideoHelperSuite](https://github.com/Kosinkadink/Hanzo Studio-VideoHelperSuite) 
- [Hanzo Studio-hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux)

You can use [Hanzo Manager](https://github.com/hanzoui/studio-Manager) to install missing nodes or follow the installation instructions for each custom node package.
...
![Workflow File](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/wan2.1_fun_control_use_custom_nodes.webp)

<Note>
Due to the large size of video files, you can also click [here](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/wan2.1_fun_control_use_custom_nodes.json) to download the workflow file in JSON format.
</Note>

#### 1.2 Input Images and Videos Download
Please download the following image and video for input:
![Input Reference Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/input/02-robot's_eye.png)

<video
  controls
  className="w-full aspect-video"
  src="https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_control/input/02-man's_eye.mp4"
></video>
...
Thanks to the Hanzo Studio community authors for their custom node packages:
...
- You can replace `DWPose Estimator` with other preprocessors from the `Hanzo Studio-hanzo_studio_controlnet_aux` node package
...
- You can use the `Video Combine` node from `Hanzo Studio-VideoHelperSuite` to save videos in mp4 format
...
- [Hanzo Studio-WanVideoWrapper](https://github.com/kijai/Hanzo Studio-WanVideoWrapper)
