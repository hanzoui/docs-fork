...
The following models can be found at [Wan_2.1_Hanzo Studio_repackaged](https://huggingface.co/hanzoui/Wan_2.1_Hanzo Studio_repackaged) and [Wan2.1-Fun](https://huggingface.co/collections/alibaba-pai/wan21-fun-67e4fb3b76ca01241eb7e334)
...
- [wan2.1_fun_control_1.3B_bf16.safetensors](https://huggingface.co/hanzoui/Wan_2.1_Hanzo Studio_repackaged/resolve/main/split_files/diffusion_models/wan2.1_fun_control_1.3B_bf16.safetensors?download=true)
