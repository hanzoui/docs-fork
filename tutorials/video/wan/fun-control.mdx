...
- Use tools like [HanzoStudio-hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) for richer control options

## Workflow Using Custom Nodes

We'll need to install the following two custom nodes:

- [HanzoStudio-VideoHelperSuite](https://github.com/Kosinkadink/HanzoStudio-VideoHelperSuite) 
...
- You can replace `DWPose Estimator` with other preprocessors from the `HanzoStudio-hanzo_studio_controlnet_aux` node package
...
- You can use the `Video Combine` node from `HanzoStudio-VideoHelperSuite` to save videos in mp4 format
...
- [HanzoStudio-WanVideoWrapper](https://github.com/kijai/HanzoStudio-WanVideoWrapper)
