---
title: "Hanzo Studio Wan2.1 Fun InP Video Examples"
description: "This guide demonstrates how to use Wan2.1 Fun InP in Hanzo Studio to generate videos with first and last frame control"
...
<Tip>
Currently, Hanzo Studio natively supports the Wan2.1 Fun InP model. Before starting this tutorial, please update your Hanzo Studio to ensure your version is after [this commit](https://github.com/hanzoai/studio/commit/0a1f8869c9998bbfcfeb2e97aa96a6d3e0a2b5df).
</Tip>
...
![Workflow File](https://raw.githubusercontent.com/hanzoui/example-workflows/main/wan2.1_fun_inp/wan2.1_fun_inp.webp)
...
- [wan2.1_fun_inp_1.3B_bf16.safetensors](https://huggingface.co/hanzoui/Wan_2.1_HanzoStudio_repackaged/resolve/main/split_files/diffusion_models/wan2.1_fun_inp_1.3B_bf16.safetensors?download=true)
...
![Hanzo Studio Wan2.1 Fun InP Video Generation Workflow Diagram](/images/tutorial/video/wan/fun_inp_flow_diagram.png)
