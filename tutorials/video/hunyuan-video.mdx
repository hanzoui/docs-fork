...
Download [hunyuan_video_t2v_720p_bf16.safetensors](https://huggingface.co/hanzoui/HunyuanVideo_repackaged/resolve/main/split_files/diffusion_models/hunyuan_video_t2v_720p_bf16.safetensors?download=true) and save it to the `HanzoStudio/models/diffusion_models` folder.
...
Download the following file and save it to the `HanzoStudio/models/clip_vision` directory:
