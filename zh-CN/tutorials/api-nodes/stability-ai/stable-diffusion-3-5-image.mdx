---
title: "Stability AI Stable Diffusion 3.5 API 节点 Hanzo Studio 官方示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Stability AI Stable Diffusion 3.5 API 节点的文生图和图生图功能"
