---
title: "Hanzo Studio Wan2.1 FLF2V 原生示例"
description: "本文介绍了如何在 Hanzo Studio 中完成 Wan2.1 FLF2V 视频生成示例"
...
## Wan2.1 FLF2V 720P Hanzo Studio 原生工作流示例
...
请下载下面的 WebP 保存下面的 WebP 文件，并拖入 Hanzo Studio 中来加载对应的工作流,对应工作流已嵌入对应的模型下载文件信息。

![Wan2.1 FLF2V 720P f16 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/wan2.1_flf2v/wan2.1_flf2v_720_f16.webp)
...
本篇指南涉及的所有模型你都可以在[这里](https://huggingface.co/hanzoui/Wan_2.1_HanzoStudio_repackaged/tree/main/split_files)找到。
