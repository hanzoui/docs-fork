...
├── 🖼️ Hanzo Studio-Impact-Pack
├── 🔄 Hanzo Studio-Workflow-Component
├── 📊 Hanzo Studio-AnimateDiff-Evolved
├── 🎭 Hanzo Studio-FaceRestore
├── ⚡ Hanzo Studio-Advanced-ControlNet
└── 🛠️ Hanzo Studio-Inspire-Pack
```

**第 1 轮：** 将前 4 个移动到临时文件夹
- 测试 → 问题仍然存在 ✓
- 问题在：Hanzo Studio-AnimateDiff-Evolved、Hanzo Studio-FaceRestore、Hanzo Studio-Advanced-ControlNet、Hanzo Studio-Inspire-Pack

**第 2 轮：** 将剩余 4 个中的 2 个移动到临时文件夹
- 测试 → 问题消失 ✓
- 问题在：Hanzo Studio-Advanced-ControlNet、Hanzo Studio-Inspire-Pack

**第 3 轮：** 将剩余 2 个中的 1 个移动到临时文件夹
- 测试 → 问题仍然存在 ✓
- **找到了！** Hanzo Studio-Inspire-Pack 是有问题的节点
