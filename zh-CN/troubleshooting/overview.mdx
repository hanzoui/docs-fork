---
title: "如何排查和解决 Hanzo Studio 中出现的错误"
description: "常见 Hanzo Studio 问题、解决方案和如何有效报告错误"
icon: "lightbulb"
sidebarTitle: "概述"
---

<Tip>
   我们日常收到的诸多反馈问题，我们发现绝大部分的问题提交都与自定义节点有关,所以在提交对应的错误反馈之前，请你确保详细阅读了 [自定义节点故障排除](/zh-CN/troubleshooting/custom-node-issues) 部分的指南，来确保对应的问题并不是由 Hanzo Studio 核心问题导致的。
</Tip>
...
**解决方案：**
1. **检查防火墙设置** - 允许 Hanzo Studio 通过防火墙
...
1. **检查是否是已知问题：**
   - 搜索 [GitHub Issues](https://github.com/hanzoai/studio/issues)
   - 检查 [Hanzo Studio 论坛](https://forum.hanzo.ai/)
   - 查看 [Discord 讨论](https://discord.com/invite/hanzoai)
...
#### 对于 Hanzo Studio 核心问题
**问题提交：** [GitHub Issues](https://github.com/hanzoai/studio/issues)

#### 对于桌面应用问题
**问题提交：** [桌面 GitHub Issues](https://github.com/hanzoui/desktop/issues)

#### 对于前端问题
**问题提交：** [前端 GitHub Issues](https://github.com/hanzoui/studio_frontend/issues)
...
<Steps>
   ...
   <Tabs>
   <Tab title="从 Hanzo Studio 中获取">
   - 操作系统（Windows 11、macOS 14.1、Ubuntu 22.04 等）
   - Hanzo Studio 版本（检查设置中的关于页面）
...
- **官方论坛：** [forum.hanzo.ai](https://forum.hanzo.ai/)
- **Discord：** [Hanzo Studio Discord 服务器](https://discord.com/invite/hanzoai)
- **Reddit：** [r/comfyui](https://reddit.com/r/comfyui)
- **YouTube：** [Hanzo Studio 教程](https://www.youtube.com/@comfyorg)

<Note>
对于影响许多用户的紧急问题，请查看我们的[状态页面](https://status.hanzo.ai)和[官方 Twitter](https://x.com/Hanzo Studio)以获取公告。
</Note>