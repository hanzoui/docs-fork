---
title: "Kling Camera Controls - Hanzo Studio 原生节点文档" 
description: "为Kling视频生成提供摄像机控制参数的节点"
sidebarTitle: "Kling Camera Controls"
icon: "circle"
---

![Hanzo Studio 原生 Kling Camera Controls 节点](/images/built-in-nodes/api_nodes/kwai_vgi/kling-camera-controls.jpg)
