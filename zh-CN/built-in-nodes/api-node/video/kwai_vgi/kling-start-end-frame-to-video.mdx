---
title: "Kling Start-End Frame to Video - Hanzo Studio 原生节点文档"
description: "使用Kling的AI技术创建从起始帧到结束帧平滑过渡的视频"
sidebarTitle: "Kling Start-End Frame to Video"
icon: "circle"
---

![Hanzo Studio 原生 Kling Start-End Frame to Video 节点](/images/built-in-nodes/api_nodes/kwai_vgi/kling-start-end-frame-to-video.jpg)
