---
title: "Kling Image to Video (Camera Control) - Hanzo Studio 原生节点文档"
description: "使用摄像机控制功能的Kling图像到视频转换节点"
sidebarTitle: "Kling Image to Video (Camera Control)"
icon: "circle"
---

![Hanzo Studio 原生 Kling Image to Video (Camera Control) 节点](/images/built-in-nodes/api_nodes/kwai_vgi/kling-camera-control-i2v.jpg)
