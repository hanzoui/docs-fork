---
title: "Kling Image to Video - Hanzo Studio 原生节点文档"
description: "使用Kling的AI技术将静态图像转换为动态视频的节点"
sidebarTitle: "Kling Image to Video"
icon: "circle"
---

![Hanzo Studio 原生 Kling Image to Video 节点](/images/built-in-nodes/api_nodes/kwai_vgi/kling-image-to-video.jpg)
