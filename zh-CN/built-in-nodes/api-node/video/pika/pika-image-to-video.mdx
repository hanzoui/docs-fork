---
title: "Pika 2.2 Image to Video - Hanzo Studio 原生节点文档"
description: "使用Pika的AI技术将静态图像转换为动态视频的节点"
sidebarTitle: "Pika 2.2 Image to Video"
icon: "circle"
---

![Hanzo Studio 原生 Pika 2.2 Image to Video 节点](/images/built-in-nodes/api_nodes/pika/pika-2-2-image-to-video.jpg)
