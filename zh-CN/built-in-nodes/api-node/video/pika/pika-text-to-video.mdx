---
title: "Pika 2.2 Text to Video - Hanzo Studio 原生节点文档"
description: "使用Pika的AI技术将文本描述转换为视频的节点"
sidebarTitle: "Pika 2.2 Text to Video"
icon: "circle"
---

![Hanzo Studio 原生 Pika 2.2 Text to Video 节点](/images/built-in-nodes/api_nodes/pika/pika-2-2-text-to-video.jpg)
