---
title: "MiniMax Text to Video - Hanzo Studio 原生节点文档"
description: "使用 MiniMax AI将文本描述转换为视频的节点"
sidebarTitle: "MiniMax Text to Video"
icon: "circle"
---

![Hanzo Studio 原生 MiniMax Text to Video 节点](/images/built-in-nodes/api_nodes/minimax/minimax-text-to-video.jpg)
