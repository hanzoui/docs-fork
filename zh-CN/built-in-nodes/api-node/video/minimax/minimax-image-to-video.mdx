---
title: "MiniMax Image to Video - Hanzo Studio 原生节点文档"
description: "使用 MiniMax AI将静态图像转换为动态视频的节点"
sidebarTitle: "MiniMax Image to Video"
icon: "circle"
---

![Hanzo Studio 原生 MiniMax Image to Video 节点](/images/built-in-nodes/api_nodes/minimax/minimax-image-to-video.jpg)
