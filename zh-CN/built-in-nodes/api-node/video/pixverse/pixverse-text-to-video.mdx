---
title: "PixVerse Text to Video - Hanzo Studio 原生节点文档"
description: "使用PixVerse的AI技术将文本描述转换为视频的节点"
sidebarTitle: "PixVerse Text to Video"
icon: "circle"
---

![Hanzo Studio 原生 PixVerse Text to Video 节点](/images/built-in-nodes/api_nodes/pixverse/pixverse-text-to-video.jpg)
