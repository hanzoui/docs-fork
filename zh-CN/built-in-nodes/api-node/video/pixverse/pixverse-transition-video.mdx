---
title: "PixVerse Transition Video - Hanzo Studio 原生节点文档"
description: "使用 PixVerse 的AI技术创建从起始帧到结束帧平滑过渡的视频"
sidebarTitle: "PixVerse Transition Video"
icon: "circle"
---

![Hanzo Studio 原生 PixVerse Transition Video 节点](/images/built-in-nodes/api_nodes/pixverse/pixverse-transition-video.jpg)
