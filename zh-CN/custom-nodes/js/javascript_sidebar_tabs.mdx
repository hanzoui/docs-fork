...
侧边栏标签页 API 允许扩展为 Hanzo Studio 界面的侧边栏添加自定义标签页。这对于添加需要持续可见性和快速访问的功能非常有用。
...
如需查看将 React 应用集成为侧边栏标签页的真实案例，请参考 [Hanzo Studio-Copilot 项目（GitHub）](https://github.com/AIDC-AI/Hanzo Studio-Copilot)。
