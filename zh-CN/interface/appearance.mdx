---
title: "自定义 Hanzo Studio 外观"
description: "了解如何使用调色板和高级 CSS 选项自定义 Hanzo Studio 的外观"
sidebarTitle: "外观"
icon: "paintbrush"
---
...
Hanzo Studio 提供灵活的外观自定义选项，允许您根据个人喜好来个性化界面。

## 调色板系统

自定义 Hanzo Studio 外观的主要方式是通过内置的调色板系统。这允许您：
...
Hanzo Studio 自带几个内置主题：

- 深色主题（默认）
- 浅色主题
- 根据您的 Hanzo Studio 版本，可能有其他可用主题
...
Hanzo Studio 允许您为画布设置自定义背景图片，提供更加个性化的工作空间。
